...
/**
 * Lấy socket ID của player qua mỗi lần bắn
 * @param {type} player
 * @returns {undefined}
 */
...
BattleshipGame.prototype.getWinnerId = function() {
  ...
  console.log("Winner: " + this.players[this.winningPlayer].id)
...
BattleshipGame.prototype.getLoserId = function() {
  ...
  console.log("Loser: " + this.players[loser].id);
...
/**
 * Abort game
 * If one of two players out, the other will win 
 * (Nếu một trong 2 người out thì người còn lại sẽ chiến thắng)
...
BattleshipGame.prototype.getGameState = function(player, gridOwner) {
  return {
    turn: this.currentPlayer === player,                 // Đến lượt ai chơi
